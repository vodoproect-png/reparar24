...
export const cities: City[] = [
  {
    ...
    districts: [
      ...
      { id: 'chamberi', name: 'Chamberi', slug: 'chamberi', postalCodes: ['28010', '28015'] },
      { id: 'retiro', name: 'Retiro', slug: 'retiro', postalCodes: ['28007', '28009'] },
      { id: 'chamartin', name: 'Chamartin', slug: 'chamartin', postalCodes: ['28016', '28036'] },
      { id: 'arganzuela', name: 'Arganzuela', slug: 'arganzuela', postalCodes: ['28045'] },
      { id: 'tetuan', name: 'Tetuan', slug: 'tetuan', postalCodes: ['28020', '28039'] }
    ]
  },
  {
    id: 'barcelona',
    ...
    districts: [
      ...
      { id: 'gracia', name: 'Gracia', slug: 'gracia', postalCodes: ['08012', '08024'] },
      { id: 'sants', name: 'Sants-Montjuic', slug: 'sants', postalCodes: ['08004', '08015'] },
      { id: 'sarria', name: 'Sarria-Sant Gervasi', slug: 'sarria', postalCodes: ['08017', '08034'] },
      { id: 'poblenou', name: 'Poblenou', slug: 'poblenou', postalCodes: ['08005', '08018'] }
    ]
  },
  {
    id: 'valencia',
    ...
    districts: [
      ...
      { id: 'poblats-maritims', name: 'Poblats Maritims', slug: 'poblats-maritims', postalCodes: ['46011', '46024'] },
      { id: 'ruzafa', name: 'Ruzafa', slug: 'ruzafa', postalCodes: ['46004', '46006'] }
    ]
  },
  {
    id: 'sevilla',
    ...
    districts: [
      ...
      { id: 'centro', name: 'Centro', slug: 'centro', postalCodes: ['41001', '41004'] },
      { id: 'triana', name: 'Triana', slug: 'triana', postalCodes: ['41010'] },
      { id: 'nervion', name: 'Nervion', slug: 'nervion', postalCodes: ['41005', '41018'] },
  ...
  },
  {
    ...
    districts: [
      ...
      { id: 'san-jose', name: 'San Jose', slug: 'san-jose', postalCodes: ['50007', '50008'] },
  ...
  },
  {
    ...
    districts: [
      ...
      { id: 'ciudad-jardin', name: 'Ciudad Jardin', slug: 'ciudad-jardin', postalCodes: ['29014'] },
      { id: 'teatinos', name: 'Teatinos', slug: 'teatinos', postalCodes: ['29010'] },
      { id: 'carretera-cadiz', name: 'Carretera de Cadiz', slug: 'carretera-cadiz', postalCodes: ['29004'] }
    ]
  }
]
