...
**Saltos de diferencial - Por qué suceden**: El diferencial salta cuando detecta una fuga de corriente a tierra superior a su sensibilidad (normalmente 30mA en viviendas). Las causas más comunes son: electrodoméstico con aislamiento deteriorado (lavadora, lavavajillas, termo eléctrico con resistencia tocando masa), humedad en cajas de derivación empotradas en pared, enchufes con fase y neutro invertidos, o simplemente un diferencial viejo (más de 15 años) que se ha vuelto hipersensible y salta sin motivo real. Usamos pinza amperimétrica de fugas y comprobador de diferenciales para identificar qué circuito tiene el problema sin tener que desmontar media casa.

**Cuadros eléctricos - Componentes y actualizaciones**: Un cuadro eléctrico moderno según REBT tiene: ICP (Interruptor de Control de Potencia que pone la compañía, calibrado según potencia contratada), interruptor general (corta toda la vivienda), diferenciales (uno de 40A 30mA para circuitos generales, otro de 25A 30mA o incluso superinmunizado para circuitos con electrónica sensible), y magnetotérmicos por circuito (C16 para iluminación, C20 para tomas de corriente, C25 para aire acondicionado, C20 o C25 para cocina/horno). Si tu cuadro solo tiene "plomos" de rosca o fusibles cerámicos, estás con instalación de hace 40+ años que no cumple normativa actual.

**Instalaciones antiguas de aluminio**: En viviendas de 1970-1985 es habitual encontrar cableado de aluminio en vez de cobre. El aluminio tiene problemas: se oxida en las conexiones creando resistencia que genera calor, es más frágido y se rompe con manipulaciones, y las conexiones aluminio-cobre (cuando se mezclan cables antiguos con nuevos) crean par galvánico que acelera la corrosión. Si tienes instalación de aluminio y haces reforma, lo recomendable es renovar completamente el cableado a cobre porque intentar empalmar secciones da problemas a medio plazo.

**Sobretensiones y protecciones**: Con las tormentas eléctricas y las variaciones de red, es cada vez más común que se quemen electrodomésticos, ordenadores, o equipos electrónicos sensibles. Instalamos protectores contra sobretensiones (SPD Tipo 2) en cuadro general que cortan picos de tensión antes de que lleguen a los aparatos. Estas protecciones son obligatorias en zonas con alta actividad de rayos según REBT, pero son recomendables en cualquier vivienda con electrónica de valor.

**Apagones parciales en vivienda**: Si te funciona la luz del salón pero no la de los dormitorios, o tienes corriente en enchufes pero no en iluminación, el problema suele estar en un magnetotérmico específico que ha saltado, en un cable seccionado en caja de derivación (típico tras obras/reformas donde han taladrado pared y han dado a un cable empotrado), o en un neutro común roto (esto es más grave porque puede dejar fases sin equilibrar que suben tensión a 380V y queman todo). Diagnosticamos con polímetro, buscador de cables, y en casos complejos con cámara térmica para detectar puntos calientes sin romper.

**Locales comerciales y oficinas**: Los locales tienen necesidades diferentes: trifásica si tienen maquinaria o climatización fuerte (3 fases + neutro, 400V entre  fases), cuadros más grandes con protecciones específicas por zona (fuerza, iluminación, climatización, cocina si es restaurante), y potencias contratadas mayores (desde 10kW hasta 50kW en locales grandes). También trabajamos con comunidades de vecinos en cuadros generales de escalera, porteros automáticos con problemas de alimentación, iluminación de zonas comunes con temporizadores o fotocélulas, y derivaciones individuales que se quedan cortos al aumentar potencia en pisos.

**Boletín eléctrico (CIE) - Cuándo es necesario**: El Certificado de Instalación Eléctrica es obligatorio en obra nueva, ampliación de potencia, cambio de titular del suministro en alquiler/compra, y tras modificaciones sustanciales de la instalación. Lo emitimos después de verificar que la instalación cumple REBT: secciones de cable adecuadas a intensidad, protecciones acordes, toma de tierra funcional (resistencia <20 ohmios en viviendas), y ausencia de defectos graves. El boletín se presenta en Industria y en la compañía eléctrica. Sin boletín en regla, no te dan de alta el suministro.

**Seguridad ante todo - Lo que NO debes hacer**: No manipules el cuadro eléctrico si no sabes lo que haces. No pongas un magnetotérmico de más amperaje "para que no salte" (eso anula la protección del cable que puede sobrecalentarse). No hagas puentes en el diferencial "porque salta mucho" (estás anulando la protección contra electrocución). No uses regletas en cadena para multiplicar enchufes sin control de carga. La electricidad no se ve, no se oye, y cuando hay problema puede ser mortal o causar incendio. Si notas olor a quemado, chispas, o cables/enchufes que se calientan, corta el diferencial general y llama a un profesional.

**Precios con contexto real**: Visita y diagnóstico con equipos de medición 59€ (descontable si contratas reparación). Localización de avería en circuito con pinza de fugas 70-100€. Sustitución de diferencial o magnetotérmico 60-90€ (pieza + mano de obra). Reparación de cuadro eléctrico con reorganización de protecciones 120-200€. Ampliación con nuevo circuito (cable empotrado, caja, mecanismos) 150-300€ según metros. Actualización cuadro completo con protecciones modernas 300-600€ según número de circuitos. Boletín eléctrico incluido en instalaciones/modificaciones que lo requieran.

**Emergencias eléctricas reales**: Atendemos 24/7 cuando te quedas sin luz por fallo en cuadro, cuando salta todo y no sabes rearmarlo, cuando hay olor a quemado de origen eléctrico, cuando tras una tormenta no funciona nada, o cuando un circuito colapsa y necesitas solución ya. Hemos reparado cuadros de comunidades enteras en domingo festivo, restablecido suministro en locales comerciales que no podían abrir, y resuelto cortocircuitos nocturnos que dejaban edificios sin ascensor ni puertas automáticas.

**Sobre normativa y certificación**: Nuestros electricistas tienen el carné profesional de instalador eléctrico de baja tensión (categoría básica o especialista según tipo de trabajo). Trabajamos según REBT (Reglamento Electrotécnico de Baja Tensión, Real Decreto 842/2002 actualizado). Emitimos boletín eléctrico (CIE) ante Industria cuando la instalación lo requiere. Disponemos de seguro de responsabilidad civil profesional de 600.000€ que cubre daños derivados de la intervención. Cada trabajo incluye garantía de 6 meses en mano de obra. Facturamos con desglose completo de materiales eléctricos utilizados (diferenciales, magnetotérmicos, cables, mecanismos) para transparencia total.

Si tienes dudas sobre si tu instalación es segura, si después de una reforma eléctrica no te han dado boletín, o si simplemente quieres una revisión preventiva antes de que falle algo importante, contacta con nosotros. La electricidad requiere respeto y conocimiento técnico - es mejor prevenir que lamentar.`,
    benefits: [
